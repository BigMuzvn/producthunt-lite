      ...
      <div className="container
       store-ratings-inner">
        <div className="store-card">
          <div className="store-card-icon store-card-icon-dark"><img src="/src/assets/playstore.png" alt="logo-Play Store" /></div>
        ...
        <div className="store-card">
          <div className="store-card-icon store-card-icon-accent"><img src="/src/assets/apple-logo.png" alt="logo-App Store" /></div>
          <div className="store-card-content">
            <div className="store-card-stars">
              <StarIcon /><StarIcon /><StarIcon /><StarIcon /><StarIcon />
            </div>
